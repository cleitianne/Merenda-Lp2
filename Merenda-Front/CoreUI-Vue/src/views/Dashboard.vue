<template>
  <div class="animated fadeIn">
    ...
    <b-card>
      <b-row>
        <b-col sm="5">
          <h4 id="traffic" class="card-title mb-0">Acompanhamento</h4>
          <div class="small text-muted">Março 2019</div>
        </b-col>
        <b-col sm="7" class="d-none d-md-block">
          ...
          <b-button-toolbar class="float-right" aria-label="Toolbar with buttons group">
            <b-form-radio-group class="mr-3" id="radiosBtn" buttons button-variant="outline-secondary" v-model="selected" name="radiosBtn">
              <b-form-radio class="mx-0" value="Day">Dia</b-form-radio>
              <b-form-radio class="mx-0" value="Month">Mês</b-form-radio>
              <b-form-radio class="mx-0" value="Year">Ano</b-form-radio>
            </b-form-radio-group>
          </b-button-toolbar>
        </b-col>
      </b-row>
